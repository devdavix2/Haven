...
<li class="sidebar-item">
  <a class="sidebar-link" href="appointments.php" aria-expanded="false">
    ...
    <div class="body-wrapper">
      ...
      <div class="row">
        ...
        <h3 class="card-title fw-semibold"> General Settings</h3>
      <br>
      <br>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title fw-semibold">Notification Settings</h5>
          <form action="update_notifications.php" method="post">
            ...
            <button type="submit" class="btn btn-primary">Save Notifications Settings</button>
          </form>
        </div>
      </div>
    </div>
   ...
   <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title fw-semibold">Security Settings</h5>
          <form action="update_security_settings.php" method="post">
            ...
            <div class="mb-3">
              ...
              <ul class="list-group">
                <li class="list-group-item">September 23, 2024 - 12:34 PM - IP: 192.168.1.10</li>
                <li class="list-group-item">September 20, 2024 - 09:17 AM - IP: 192.168.1.12</li>
              </ul>
            </div>
